...
export default function Sidebar({
  ...
  return (
    <div
      className={`fixed md:sticky top-0 left-0 h-full md:min-h-screen w-64 bg-signature-red-linear-vertical text-white p-4 transform transition-transform duration-300 ease-in-out
